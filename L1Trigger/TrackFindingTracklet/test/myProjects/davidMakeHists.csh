...
# Edited by David Abrahamyan to cycle over many different root files made in truncation
# examination and output different files based on the names.
...
# \root -l -b -q ${plotMacro}'("'${inputFileStem}'","'${dirName}'")' 
...
\root -l -b -q ${plotMacro}'("'${inputFileStem}'","'${dirName}'")' | tail -n 19 >! results.out 
cat results.out
