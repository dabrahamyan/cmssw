...
void overlayHists_newkfTest (){
    ...
    for (int iDataSet = 0; iDataSet < dataSets.size(); iDataSet++) {
        ...
        TFile *newkfFile= new TFile(dir + "output_SingleMuonPU0_newkfTest_13_3_0.root");
        ...
        for (int iParam = 0; iParam < params.size(); iParam++) {
            ...
            leg->Draw();
            c.SaveAs(saveDir + "output_SingleMuonPU0_newkfTest_13_3_0" + "_" + prop + params[iParam] + ".pdf");
