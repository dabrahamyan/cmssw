...
eosDirName = 'DisplacedCombinedBugFix' # Dir in eos you want to write to
...
with open(filename,'r') as f:
    ...
    while True:
        ...
        create += 'cmsRun ' + cfgFile + ' inputFiles='+input+' outputFile=/eos/user/d/dabraham/' + eosDirName + '/' + dataName + '_'+str(counter1)+'.root maxEvents=10000\n'
