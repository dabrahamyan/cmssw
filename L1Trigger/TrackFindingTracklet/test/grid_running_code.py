...
############## Things to Change ###################
dataName = 'TTbarPU200D88_HYBRID_combined_fullTrunc_TEST_assertsOn_oneTrunc' # what submit files and output files are named (no ".root")
...
# dataName = 'TTbarPU200D88_NEWKF_combined_TPTrunc_assertsOn_oneTrunc' # what submit files and output files are named (no ".root")
...
with open(filename,'r') as f:
    ...
    while True:
        ...
        for line in lines:
            ...
            counter2+=1
        create = '#!/bin/bash\n' ##writng .sh file
        create += 'export CMSSW_PROJECT_SRC=/afs/cern.ch/user/d/dabraham/private/test/' + newCMSSW + '/src\n' 
        ...
        create += 'cd /afs/cern.ch/user/d/dabraham/private/test/' + newCMSSW + '/src/L1Trigger/TrackFindingTracklet/test\n'## go the directly where you have the producer and python config file
