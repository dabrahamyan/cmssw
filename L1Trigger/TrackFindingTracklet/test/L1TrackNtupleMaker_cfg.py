...
process.TFileService = cms.Service("TFileService", fileName = cms.string('newkfDebug_SingleMuon_DR_off_stubs_check_plus10_retryCompile.root'), closeFileFast = cms.untracked.bool(True))
