...
TrackTriggerDemonstrator_params = cms.PSet (
  ...
  LabelIn  = cms.string( "TrackerTFPProducerPP"              ), #
  LabelOut = cms.string( "TrackerTFPProducerDR"              ), #
  DirIPBB  = cms.string( "/heplnw039/tschuh/work/proj/ppdr/" ), # path to ipbb proj area
