...
void overlayHists (){
    ...
    TFile *muonFile= new TFile(dir + "output_SingleMuon_PU200_D88.root");
    ...
    etaLeg->AddEntry(muonEtaHist, "Single Muon PU200");
    etaLeg->AddEntry(TTbarEtaHist, "TTbar PU0");
    ...
    ptLeg->AddEntry(muonEtaHist, "Single Muon PU200");
    ptLeg->AddEntry(TTbarEtaHist, "TTbar PU0");
    ...
    phiLeg->AddEntry(muonEtaHist, "Single Muon PU200");
    phiLeg->AddEntry(TTbarEtaHist, "TTbar PU0");
    ...
    z0Leg->AddEntry(muonEtaHist, "Single Muon PU200");
    z0Leg->AddEntry(TTbarEtaHist, "TTbar PU0");
